...
if(MSVC)
	...
	target_include_directories(bgfx PRIVATE "bx/include/compat/msvc" PRIVATE ${includes})
elseif(WIN32)
	target_include_directories(bgfx PRIVATE "bx/include/compat/mingw" PRIVATE ${includes})
elseif(APPLE AND NOT UNIX)
	target_include_directories(bgfx PRIVATE "bx/include/compat/osx" PRIVATE ${includes})
endif()