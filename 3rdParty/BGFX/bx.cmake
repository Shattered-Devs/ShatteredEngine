...
if(MSVC)
	...
	target_include_directories(bx PRIVATE "bx/include/compat/msvc" ${includes})
elseif(WIN32)
	target_include_directories(bx PRIVATE "bx/include/compat/mingw" ${includes})
elseif(APPLE AND NOT UNIX)
	target_include_directories(bx PRIVATE "bx/include/compat/osx" ${includes})
endif()