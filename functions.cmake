...
function(search_libs target_name)
	if(_SHATTERED_WINDOWS_X86 AND NOT _SHATTERED_WINRT)
		target_link_directories(${target_name} PUBLIC "../libs/Windows/x86")
	elseif(_SHATTERED_WINDOWS_X64 AND NOT _SHATTERED_WINRT)
		target_link_directories(${target_name} PUBLIC "../libs/Windows/x64")
	elseif(_SHATTERED_WINDOWS_X64 AND _SHATTERED_WINRT)
